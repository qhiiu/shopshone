    ...
    <div class="container">
        ...
        <div class="pull-right">
            <div class="beta-breadcrumb font-large">
                <a href="{{route('trangchu')}}">Trang chủ</a> / <span>Thông tin chi tiêt san phẩm</span>
            </div>
        </div>
                        ...
                        <div class="single-item-body">
                            ...
                            <p class="single-item-price">
                                ...
                                @else
                                    ...
                                    <span class ="flash-sale">{{number_format($sanpham->prmotion_price)}} VND</span>
                                ...
                                <div class="single-item-body">
                                    ...
                                    <p class="single-item-price">
                                            ...
                                            @else
                                                ...
                                                <span class ="flash-sale">{{number_format($sptt->prmotion_price)}} VND</span>

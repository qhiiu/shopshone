...
<div class="fullwidthbanner-container">
    <div class="fullwidthbanner">
        ...
        <div class="banner" >
                <ul>
                    @foreach ($slide as $sl)
                    {{-- dùng leẹnh foreach để in ra danh sách slide --}}
...
<div class="row">
    <div class="col-sm-12">
        <div class="beta-products-list">
            <h1  style="  color: rgba(255, 0, 210, 0.97);text-align: center;">Sản Phẩm Mới</h1>
                    ...
                    <div class="col-sm-3" style="padding: 20px;">
                        <div class="single-item">
                            ...
                            <div class="single-item-body">
                                <p class="single-item-title"  style="font-size: 21px">{{ $new->name }}</!-->
...
{{-- --------------------------------------------------------------------------------- --}}
        ...
        <div class="beta-products-list">
            <h1  style="  color: rgba(255, 0, 210, 0.97);text-align: center;">Sản phẩm khuyến mãi</h1>
            <div class="beta-products-details">
